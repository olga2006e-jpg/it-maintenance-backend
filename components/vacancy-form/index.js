...
//     getHTML() {
//         const title = this.mode === 'edit' ? 'Редактирование карточки' : 'Добавление карточки';
...
//                                         <button type="button" id="cancel-form" class="btn flex-grow-1" style="background: #BA2E3A; color: floralwhite; border: none; padding: 10px;">Отмена</button>
//                                     </div>
//                                 </form>
//                             </div>
//                         </div>
...
export class VacancyFormComponent {
    ...
    getHTML() {
        ...
        // ДЛЯ РЕДАКТИРОВАНИЯ - БЕЗ КНОПОК И БЕЗ ПОДПИСИ АВТОСОХРАНЕНИЯ
        if (this.mode === 'edit') {
            return `
                <div class="container mt-4">
                    <div class="row justify-content-center">
